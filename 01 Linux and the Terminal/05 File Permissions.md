...
Example Output (split on multiple lines):
```
-rw-rw-r--              permission string
1                       number of links to the file
josh                    user that owns the file
josh                    group that owns the file
28                      size of the file in bytes
Sep 16 14:00            last modification date
hello.py                name of file
```
